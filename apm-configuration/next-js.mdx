...
<Accordion title="Step 1: Install Next.js APM Package">
...
<Accordion title="Step 2: Modify Config File">
...
<Note>If your application is not running in a container or Kubernetes cluster, move to Step 4</Note> 
...
<Accordion title="Step 4: Create Instrumentation File">
    <Accordion title="Step 4a: Custom Instrumentation">
    ...
    <Accordion title="Step 4b: Synchronize Instrumentation">
...
<Accordion title="Step 6: Deploy your Project">
...
For more information on Continuous Profiling, navigate to [Workflows](https://docs.middleware.io/workflow/profiling) to find out more.
