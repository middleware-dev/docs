...
2. PHP version 8+, you can check your PHP version with the following command.
  ```shell Shell
  php -v
  ```
3. <a href="https://pecl.php.net/"> Pecl </a> and <a href="https://getcomposer.org/"> Composer </a> and the otel-instrumentation PHP extension (see below)
