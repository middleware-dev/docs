...
```
<Note>You can find your &lt;ACCESS-TOKEN,&gt; on the Installation screen for <a href="https://app.middleware.io/installation?installation_integration=nextjs#instrumentation/apm" rel="nofollow noopener noreferrer" target="_blank" translate="no" color="blue">NextJs / Vercel</a>.</Note>
