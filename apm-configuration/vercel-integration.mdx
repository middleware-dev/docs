...
After integrating Middleware with Vercel, you will now be able to centralize all of your log data in the Middleware's Log page. Change your Vercel log collection configuration by navigating to __Integrations__, selecting __Log Drains__, and clicking __Manage__:
