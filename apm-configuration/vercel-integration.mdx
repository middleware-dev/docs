...
<Accordion title="Step 1: Add Middleware Integration">
    <Accordion title="Step 1a: Add Integration">
        Add the [Middleware Integration](https://vercel.com/integrations/middleware/new) from the Vercel marketplace:
    ...
    <Accordion title="Step 1b: Add Vercel Account">   
    ...
    <Accordion title="Step 1c: Select Your Project">     
    ...
    <Accordion title="Step 1d: Add Integration">
        Allow Permissions and Add Integration:
    ...
    <Accordion title="Step 1e: Login to Your MW Account">
        Login to your Middleware Account:
    ...
    <Accordion title="Step 1f: Check Integration Status">
    ...
    <Accordion title="Step 1g: Enable Traces">
...
<Accordion title="Step 4: Create Instrumentation File">
    <Accordion title="Step 4a: Create instrumentation.ts file">
    ...
    <Accordion title="Step 4b: Synchronize Instrumentation File">
    ...
    <Accordion title="Step 4c: Add Code Snippet">
    ...
    <Accordion title="Step 4d: Integrate APIs & Serverless Functions">
...
Learn more about Continuous Profiling [here](https://docs.middleware.io/workflow/profiling).
