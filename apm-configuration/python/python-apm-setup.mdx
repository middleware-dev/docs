...
```
<Note>You can find your \{YOUR-ACCESS_TOKEN\} on the Installation screen for <a href="https://app.middleware.io/installation?installation_integration=python#instrumentation/apm" rel="nofollow noopener noreferrer" target="_blank" translate="no" color="blue">Python</a>.</Note>
