...
1. Middleware Host Agent (MW Agent), to install the MW Agent please see our [installation guide](https://docs.middleware.io/docs/agent-installation/overview).

2. Ruby version 3.0.0, you can check your Ruby version with the following command.
```bash Shell
ruby --version
```
