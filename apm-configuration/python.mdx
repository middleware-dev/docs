...
2. `Python 3 version 3.8` or above recommended. Check your Python version with the following command.
```bash Shell
python3 --version
```

3. `pip version 23.1.2`. Check your pip version with the following command.
```bash Shell
pip --version
```
...
### Traces, Metrics, Logs, & Profiling Data

Create a `.ini` file based on the features you want to observe
