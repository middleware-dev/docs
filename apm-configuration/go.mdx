...
1. The Middleware Host Agent (MW Agent). To install the MW Agent please see our <a href="https://docs.middleware.io/docs/agent-installation/overview"> installation guides </a>. 

2. One of the two latest Go stable releases. Check <a href="https://go.dev/doc/devel/release"> Go’s docs </a> for details. You can check your Go version with the following command.
```javascript Shell
go version
```
...
<Accordion title="Step 1: Install Go package">
...
<Accordion title="Step 3: Framework-Specific Configuration">
...
<Accordion title="Step 5: Capture Application Data">
