...
<Steps>
  ...
  <Step title="Go Version">
     One of the two latest Go stable releases. See <a href="https://go.dev/doc/devel/release"> Go docs </a> for details. Check your Go version with the following command.
     ```javascript Shell
     go version
     ```
  </Step>
