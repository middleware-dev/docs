...
<Steps>
  ...
  <Step title="Go Version">
     One of the two latest Go stable releases. Check <a href="https://go.dev/doc/devel/release"> Go’s docs </a> for details. You can check your Go version with the following command.
     ```javascript Shell
     go version
     ```
  </Step>
