...
<Note>[React Navigation 5 & 6](https://reactnavigation.org/docs/getting-started#installation) and [Expo](https://docs.expo.dev/) are both supported React Native frameworks</Note>
