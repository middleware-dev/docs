...
The Performance Summary provides insight into your top-level RUM performance data. Learn about your Core Web Vitals Metrics, the total errors incurred, and the total unique user sessions and pages visits within a certain period of time.

![](https://lh7-us.googleusercontent.com/0VNW2N5_GdWBkfztTGMD0bAGwSyZhbxMG6Gga00CZ8QSae-05rHQ9NSC_Lwi7akpGrsV3NalAf_ab6KDCxNvpok5Jw2Mn5u4VTUNUNu6GNQHQebiD253eXJNa3x06B8bCPEXaOXruoK2F2tycmdu1C0)

## Session & Replays

The Session & Replays section provides insight into your top-level RUM Session data and the ability to drill into specific session details to easily diagnose issues and understand user behavior.

Select from the Sessions table to drill into a RUM Session. Get time stamped recordings of users' interactions.

* include gif of user accessing contiinuous profiling

## Browser Errors

The Browser Errors section provides insight into when and where your application throws Errors.

![](https://lh7-us.googleusercontent.com/sBtmkfYANQAniUTVEgREs4IAQ_xPiEE4uFy8QqdNvjut5yAdDW8ApDuYF0yMqw2qSKx8xMzzrrEHXfZ6-DON9nHvw6utveB0d1fI3cgewK5eaIPIeFs0oXtrhKjA-8GjteuBV0nG4PhAh6eGChRqPYk)
...
<img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExaGF4ZzRxN3JocGRkZTl2cWcybGVuYWRhaG5yN3Y1bzNzOThncXZqMiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/fDz8nkYcv8gKeHKNOs/giphy.gif" width="900" height="900" />
