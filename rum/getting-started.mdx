...
Use these functions to keep track of different types of issues in your system, making it easier to monitor and fix problems. This way you can save it as custom logs and view it under Log section and also create alerts on these logs. 
...
<Note> The `tracePropagationTargets` value must be in regex format. </Note>
