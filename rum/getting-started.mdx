...
| `projectName`          | String   | ✖️                        | URL of application                       | The name of the project.               |
| `accountKey`           | String   | ✅                        |                        | The account key for authentication.    |
| `target`               | String   | ✅                        |                        | The target URL for the service.        |
| `env`                  | String   | ✖️                        | `"prod"`                       | The environment of the service.        |
| `recording`            | String   | ✖️                        | `"1"`                    | Indicates if recording is enabled.     |
| `tracePropagationTargets` | Array  | ✖️                        |                        | Targets for trace propagation.        |
