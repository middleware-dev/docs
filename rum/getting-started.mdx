...
Add `tracePropagationTargets` to your SDK from [Step 3](#step-3-initialize-the-sdk) of the RUM Installation. Ensure the `tracePropagationTargets` variable must be in regex format
