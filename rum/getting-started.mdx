...
<Warning> If you are installing RUM with `Next.js`, you will not have a template HTML file. Once you have completed Installation Steps 1-3, move to the  __Next.js - Installing Without an index.html File__ section. </Warning>
