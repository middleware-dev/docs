...
Session Listing
---------------
<img src="/images/rum/run-session-list.png" />
In this tab you will get all the session list with their aggregated details.

* User Status: You can check if the user is still on your site or not (Live / Offline).
* Recording Availability: Quickly determine whether a session has a recording available.
* Visitor Info: You can identify visitor by their location and device. 
