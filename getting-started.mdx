...
<CardGroup cols={2}>
    <Card title="Instrumentation" color="#e95e5f" icon="square-1" href="https://docs.middleware.io/agent-installation/overview#installing-the-middleware-agent">
        Install the Docker, Kubernetes, Linux, Windows Agent or go serverless
    </Card>
