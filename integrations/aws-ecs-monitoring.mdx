...
<AccordionGroup>
    ...
    <Accordion title="Step 2 : Add this log Configuration in your main container">
        ...
        The Middleware Agent sidecar will fetch these logs and send them to Middleware.
...
<Warning> The MW Agent must be running as an app before setting up collection. If not, attempted trace collection will throw an error while connecting to the agent and logs will not be sent at all.</Warning>
