...
The Apache Network Integration provides real-time visibility into your teams server performance and statistics. This integration is useful for teams that want to understand the number of requests made to your servers, workers in each state, cumulative server traffic and much more.
...
All Apache related data is accessible in our widget builder through `apache.*` metrics. See below for comprehensive list
