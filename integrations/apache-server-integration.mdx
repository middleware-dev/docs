...
The Apache Network Integration provides real-time visibility into your teams server performance and statistics. Analyze the number of requests made to your servers, workers in each state, cumulative server traffic and much more.
