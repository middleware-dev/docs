---
title: "MongoDB"
description: MongoDB Integration - Setup & Installation Docs | Middleware
---

The MySQL Integration allows users to ingest and monitor the performance and health metrics of their NoSQL database instances. This integration is useful for tracking the total number of active connections and operations executed within your instances, the total space allocated to database indexes, the count of all document operations executed, and much more. 
