---
title: "Opsgenie"
description: Opsgenie Integration - Setup & Installation Docs | Middleware
---

The Opsgenie Integration allows you to create and assign incidents to team members within your Opsgenie organization. Track the total amount of resources consumed by your incident management tool in the Middleware platform.
...
<Steps>
  ...
  <Step title="Opsgenie Account">
    Opsgenie Account with `admin` level access
  </Step>
