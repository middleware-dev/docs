...
The PostgreSQL Integration allows users to ingest and monitor the performance and health metrics of their object-relational database management system (ORDBMS) data. This integration is useful for tracking the total number of blocks read into memory, identifying disk space utilization per table, tallying insert operations and rollbacks triggered, and much more.
