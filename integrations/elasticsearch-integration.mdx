...
Create a `.yaml` file in your system to store your database collection details
...
### Step 2: Add Elasticsearch Credentials to the YAML file

Add credentials for the user which you'd like Middleware to connect as. This user should be an Elastic superuser as defined [here](https://www.elastic.co/guide/en/elasticsearch/reference/current/built-in-users.html).
...
### Step 3: Connect Elasticsearch Integration

Login to your Middleware account, navigate to the Database Monitoring section and connect Elasticsearch

### Step 4: Add Elasticsearch Credential Path

Select a host and set the YAML path to the file created in steps 1 and 2
