...
Quickly access your Cassandra data with Middleware’s default Cassandra dashboard. Navigate to the Dashboard Builder and select `Cassandra - Metrics Dashboard`
