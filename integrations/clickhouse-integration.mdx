...
<Accordion title="Step 1: Update ClickHouse Configuration">
...
<Accordion title="Step 2: Navigate to ClickHouse Integration">
    Login to your Middleware account, navigate to the ClickHouse integration, and connect ClickHouse

    <img src="/images/integration/clickhouse-integration-page.png" />
</Accordion>

<Accordion title="Step 3: Connect ClickHouse Instance">
    To access Redpanda metrics, choose a host to connect to your Redpanda instance
</Accordion>

<Accordion title="Step 4: Configure ClickHouse Instance">
    Configure your host to connect to the IP address and port that ClickHouse stores its metrics

    <img src="/images/integration/clickhouse-connectivity.png" />
...
<img src="/images/integration/clickhouse-dashboard.png" />
...
<img src="/images/integration/clickhouse-widget.png" />
