---
title: ClickHouse
description: ClickHouse Integration - Setup & Installation Docs | Middleware
---

The ClickHouse Integration allows users to effortlessly ingest and monitor their column-oriented ClickHouse data. This integration is useful for identifying system-wide usage patterns, performance bottlenecks in your ClickHouse clusters, analyzing high-volume SQL query performance in real-time, and much more.
...
<img src="/images/integration/clickhouse-host.png" />
