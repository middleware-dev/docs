---
title: Log Monitoring - Search & Filter
sidebarTitle: Search & Filter
---

The Search and Filter features within the Logs page provides a streamlined method for accessing your data. Create persistent filters to preserve your customized views, efficiently browse through your logs, and access important collections of logs in a single button click.

To quickly filter your log data, use the left most column on the logs page to toggle on and off filters sorted by __Levels__, __Additional__, __NameSpace__, __APM Projects__, and __Sources__.

![](https://lh7-us.googleusercontent.com/K6KDnttUMNeKck9XAhFXHbMrB9Qoz0JUys8gWQzGzyaAMzUZtv6fqUsNj11-k8Y0FvLY_yNnIq_PD-jCTe526v1-Ji7ELlBJ3gRTXe-UkWZmERWeAm8X4zxWqmQT3IMa8jw_5Eb6hj5GMsyWHGHJmu8)

# Create New Filters

Filters allow you to easily access data without redundantly filtering through irrelavent logs. Create a custom filter that you have access to with a single click.
