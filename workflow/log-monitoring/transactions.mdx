...
<Tabs>
  <Tab title="Container Name">
    `container_name` is aggregated across all logs and then a secondary aggregation is performed specifically on containers whose names contain the subpattern or string `kafka`
