...
Transactions traverse across your system and aggregate your log data with other data that exists outside of the log you are already filtering. This feature is useful when you need to identify broader patterns within your infrastructure that are related to the log you are actively filtering. 

Transactions work by compiling indexing logs based on occurrences of a series of actions, like a user's session or a request handled across your microservice architecture. Examples of transactions range from actions within a mobile app, to function calls and CPU instructions.

# Transaction Measures

Measures are additional ways for you to filter your transactions:
...
Navigate to the logs page, select the Transactions tab, choose your desired aggregation metric, and add one or multiple measures to filter your data even further. 
