...
<Note> You have the option to create a dashboard from an existing data source or create a widget. We recommend starting with the Dashboard. </Note>
...
The Group By field is the outer most aggregation made in your query. The way in which you aggregate a metric is contingent on the initial metric you have selected for your widget. Group your initial metric with resource attributes, metric attributes, or another metric based on the selected metric. 
...
The Date Range picker allows you to select the exact period of time to view your dashboard data.

### Metrics

Filter all of your metrics based on the dynamically available data within your dashboard. Visualize the performance of a single metric within your broader dashboard.
