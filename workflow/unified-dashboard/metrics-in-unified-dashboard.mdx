---
title: "Metrics in Unified Dashboard"
---
Overview
-------
...
As per the selected timeframe in the chart, the following metrics will be displayed: 

-   Total machines (including down machines)
-   Total containers that each machines has
-   Total services
-   Total processes that are running on those machines

![](/images/unified-dashboard/dashboard-4.png)
...
![](/images/unified-dashboard/dashboard-5.png)

### Machines
This section shows the number of machines in the cluster in a honeycomb-like pattern. The machines are grouped by their status as running or down. You can get more details about each machine by hovering over any honeycomb. You want to filter out all 3 sections of the dashboard based on any particular machine only by clicking on any machine, and that will apply a filter on the dashboard, so the rest of the cards & sections will display data accordingly.

<Note> It will only show you up to 100 hexagons of recently installed machines, If you have 100+ machines installed, you can go to Infrastructure > Host-list screen to view the list of all machines. </Note>

![](/images/unified-dashboard/dashboard-6.png)
...
![](/images/unified-dashboard/dashboard-7.png)
...
![](/images/unified-dashboard/dashboard-8.png)
...
![](/images/unified-dashboard/dashboard-9.png)

### Network Usages
Network Usages displays usage based on bandwidth type. One is for Receiving bandwidth, and the other for Transmitting bandwidth. Each graph shows the bandwidth of the recently installed 25 machines. From this graph, we can compare which machines consume higher bandwidth to Receive & Transmit data packets.

![](/images/unified-dashboard/dashboard-10.png)

### Disk Usage
Disk Usage displays Read & Write speed of any machine in the cluster.

![](/images/unified-dashboard/dashboard-11.png)
...
![](/images/unified-dashboard/dashboard-12.png)
