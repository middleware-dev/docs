...
<p style={{fontSize:"14px",marginBottom:"10px"}}>* Replace the MW_API_KEY value with your API key or directly copy the full command with the API key from the installation menu.</p>
