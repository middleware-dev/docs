...
This guide provides an overview of the Middleware Agent and instructions for its installation on [Kubernetes](/agent-installation/kubernetes), [Linux](/agent-installation/linux), and [Docker](/agent-installation/docker), and [Windows](/agent-installation/windows).
