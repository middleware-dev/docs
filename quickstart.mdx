...
<CardGroup cols={3}>
  <Card title="Instrumentation" icon="octagon-plus" iconType="solid" color="#e95e5f" href="https://docs.middleware.io/agent-installation/overview#installing-the-middleware-agent">
