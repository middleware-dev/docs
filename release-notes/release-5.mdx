...
- Improved sharing of RUM links with filters as query parameters within RUM to easily share user-specific sessions with your teammates
...
- Filter the Span List to see a deeper view of all spans related within the APM Dashboard by parent `SpanID` to quickly identify what you are looking for
...
- When users change their page from History mode to Live mode, Live mode now only displays the last 5 minutes instead of the last hour
