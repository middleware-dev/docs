...
- Python APM can now support applications written with the Django framework
- New Kubernetes Infrastructure Monitoring Dashboards:
    1. Horizontal Pod Autoscalers
    2. Network Services
    3. Network Ingress
    4. Persistent Volume (and Volume Claim) Storage
    5. Service Accounts
    6. Cluster Roles
    7. Roles
    8. Cluster Role Bindings
    9. Role Bindings
