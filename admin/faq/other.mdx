...
<Accordion title="How can I send custom metrics?">
...
<Accordion title="Are you able to create alerts with Synthetic Monitors?">
...
<Accordion title="Can I use Middleware to monitor Azure services?">
    ...
    <Note> We are currently working on Cloud specific integrations </Note>
...
<Accordion title="Which cloud platforms can be monitored by Middleware ?">
