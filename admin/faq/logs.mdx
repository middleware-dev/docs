...
<Accordion title="What is charge of log rehydration?">
...
<Accordion title="How to create alerts on custom logs?">
    Go to Alerts -> Create new -> choose the detection method Logs <br/>
    Now select "Log type" -> message <br/>
    ...
    <img src="/images/alert/log alert.png" />
</Accordion>
