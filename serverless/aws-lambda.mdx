...
This guide walks you through instrumenting AWS Lambda wtih OpenTelemetry and Middleware. These instructions can also be found on the Installation page in your [Middleware Account](https://app.middleware.io/installation#infrastructures/windows).
