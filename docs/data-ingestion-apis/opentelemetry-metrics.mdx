...
EOF
```
<Note> We accept data in [OTLP/HTTP](https://opentelemetry.io/docs/reference/specification/protocol/otlp/#otlphttp) format. </Note>
...
| k8s.daemonset | k8s.daemonset.uid | ✖️ |
| k8s.replicaset | k8s.replicaset.uid | ✖️ |
| k8s.statefulset | k8s.statefulset.uid | ✖️ |
| k8s.namespace | k8s.namespace.uid | ✖️ |
| service | service.name | ✖️ |
| os | os.type | ✖️ |  
