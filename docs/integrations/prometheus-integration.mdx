...
If you want to scrape prometheus endpoint via Middleware Agent, You will have to run this `sidecar` container in your pod.
...
This will start scraping prometheus data at `:8889`