Overview
--------
Install the [Middleware agent](https://docs.middleware.io/docs/kubernetes) in your Kubernetes clusters to start collecting your cluster and application metrics, traces, and logs.
