Overview
--------
Once [Infrastructure Agent](https://docs.middleware.io/docs/installation) is installed, you can see all the hosts under "Host List" with details. This helps to visualize host performance and health. 
