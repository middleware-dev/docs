...
Every machine/host in your infrastructure is billed monthly $10. 
<P> A host is any physical or virtual OS instance that you monitor with Middleware. It could be a server, VM, node (in the case of Kubernetes), or App service plan instance (in the case of Azure app services). </P>
