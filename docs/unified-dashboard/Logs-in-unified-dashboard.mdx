...
To get more details of each log, you can click on any log so it will open a side panel to elaborate more on that log with its Tags, Properties, Raw data & Source/Similar logs. To know more about its side panel, please refer to this [link](https://docs.middleware.io/docs/logs).
