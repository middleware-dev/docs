...
## Step 1: Download JAR
Download the latest Middleware instrumentation <a href="https://github.com/middleware-labs/opentelemetry-java-instrumentation/releases/download/v1.3.0/middleware-javaagent-1.3.0.jar"> JAR file. </a>
