...
1. Must have `Next.js version 13.4` or newer installed. Check your Next.js version with the following command:
```bash Shell
npx next --version
```
...
3. Enable traces prior to deploying your project
