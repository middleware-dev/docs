...
Middleware APM does require our Middleware Host Agent (MW Agent) be installed on the application’s host infrastructure. If you do not have the MW Agent installed please see our installation guides for Kubernetes, Linux, or Docker. 
