...
Service List
------------
Once [APM is installed](https://docs.middleware.io/docs/apm-configuration), all the services running inside the application will be listed here.
